...
4. Apply quarter-turn rotation, auto-cropped straighten rotation, and
   normalized crop.
5. Apply white balance, exposure, contrast, tone curve, saturation, and the
   optional Matrix look in the documented order.
...
- The current project schema is version 13. Old versions 1–12 must continue to
